...
import trainhard.design_system.generated.resources.add_set
import trainhard.design_system.generated.resources.muscle_groups
import trainhard.design_system.generated.resources.weight_reps_template
        ...
        Column(
            ...
            Column(
                ...
                card.sets.forEachIndexed { index, (w, r) ->
                    SetElement(
                        text = stringResource(resource = Res.string.weight_reps_template, w, r),
                        isEditable = true,
            ...
            Text(
                ...
                text = stringResource(resource = Res.string.muscle_groups, card.muscles),
            ...
            TrainButton(
                modifier = Modifier
                    .align(Alignment.End),
                label = stringResource(resource = Res.string.add_set),
